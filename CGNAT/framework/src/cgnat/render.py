...
def render_field_categories(bundle: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "infra_deployable_fields": [
            ...
            _category_entry("operations.default_tags", operations["default_tags"], "operations", "Default AWS tagging policy for created resources."),
            ...
            _category_entry("operations.cgnat_head_end.ami_id", operations["cgnat_head_end"]["ami_id"], "operations", "AMI used for the CGNAT HEAD END resource."),
            _category_entry("operations.cgnat_head_end.security_group_ids", operations["cgnat_head_end"]["security_group_ids"], "operations", "Security groups used for the CGNAT HEAD END resource."),
            _category_entry("operations.cgnat_head_end.iam_instance_profile", operations["cgnat_head_end"]["iam_instance_profile"], "operations", "IAM instance profile used for the CGNAT HEAD END resource."),
            _category_entry("operations.cgnat_head_end.key_pair_name", operations["cgnat_head_end"]["key_pair_name"], "operations", "Optional key pair policy for the CGNAT HEAD END resource."),
            _category_entry("operations.cgnat_head_end.root_volume", operations["cgnat_head_end"]["root_volume"], "operations", "Root volume policy for the CGNAT HEAD END resource."),
            ...
            _category_entry("operations.cgnat_isp_head_end.ami_id", operations["cgnat_isp_head_end"]["ami_id"], "operations", "AMI used for the CGNAT ISP HEAD END resource."),
            _category_entry("operations.cgnat_isp_head_end.security_group_ids", operations["cgnat_isp_head_end"]["security_group_ids"], "operations", "Security groups used for the CGNAT ISP HEAD END resource."),
            _category_entry("operations.cgnat_isp_head_end.iam_instance_profile", operations["cgnat_isp_head_end"]["iam_instance_profile"], "operations", "IAM instance profile used for the CGNAT ISP HEAD END resource."),
            _category_entry("operations.cgnat_isp_head_end.key_pair_name", operations["cgnat_isp_head_end"]["key_pair_name"], "operations", "Optional key pair policy for the CGNAT ISP HEAD END resource."),
            _category_entry("operations.cgnat_isp_head_end.root_volume", operations["cgnat_isp_head_end"]["root_volume"], "operations", "Root volume policy for the CGNAT ISP HEAD END resource."),
