...
show_log_grep \
  ...
  'cgnat-scenario1-rpdb-empty-live-customer_vpn_router_2-outer|cgnat-scenario1-rpdb-empty-live-outer|received end entity cert|sending cert request|RSA signature|certificate|pubkey'
show_log_grep \
  "INNER SECRET NEGOTIATION LOGS" \
  'cgnat-scenario1-rpdb-empty-live-customer_vpn_router_2-inner|cgnat-s1-be-r2|pre-shared|shared key|psk'
