...
PROFILES: dict[str, DemoProfile] = {
    ...
    "cgnat-per-customer-outer-inside-nat": DemoProfile(
        key="cgnat-per-customer-outer-inside-nat",
        description="CGNAT per-customer outer demo with inside NAT on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-per-outer-inside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-per-outer-inside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
    "cgnat-per-customer-outer-inside-outside-nat": DemoProfile(
        key="cgnat-per-customer-outer-inside-outside-nat",
        description="CGNAT per-customer outer demo with inside NAT and outside NAT on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-per-outer-inside-outside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-per-outer-inside-outside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
    "cgnat-per-customer-outer-outside-nat": DemoProfile(
        key="cgnat-per-customer-outer-outside-nat",
        description="CGNAT per-customer outer demo with outside NAT only on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-per-outer-outside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-per-outer-outside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
    "cgnat-shared-isp-gateway-inside-nat": DemoProfile(
        key="cgnat-shared-isp-gateway-inside-nat",
        description="CGNAT shared ISP gateway demo with inside NAT on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-shared-isp-inside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-shared-isp-inside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
    "cgnat-shared-isp-gateway-inside-outside-nat": DemoProfile(
        key="cgnat-shared-isp-gateway-inside-outside-nat",
        description="CGNAT shared ISP gateway demo with inside NAT and outside NAT on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-shared-isp-inside-outside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-shared-isp-inside-outside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
    "cgnat-shared-isp-gateway-outside-nat": DemoProfile(
        key="cgnat-shared-isp-gateway-outside-nat",
        description="CGNAT shared ISP gateway demo with outside NAT only on the backend VPN head-end.",
        customer_name="demo-ca-cgnat-shared-isp-outside-nat",
        customer_file=_repo_file(
            "build",
            "live-validation",
            "requests",
            "demo-ca-cgnat-shared-isp-outside-nat.yaml",
        ),
        notes="Run scripts/customers/prepare_live_validation_requests.py first.",
        prepare_required=True,
    ),
