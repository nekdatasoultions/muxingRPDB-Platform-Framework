...
- the platform database baseline through [ensure_dynamodb_tables.py](/scripts/platform/ensure_dynamodb_tables.py)
  - customer SoT table
  - resource allocation table for smart provisioning
- the new empty-platform front door through [deploy_empty_platform.py](/scripts/platform/deploy_empty_platform.py)
- safe rehearsal parameter generation through [prepare_empty_platform_params.py](/scripts/platform/prepare_empty_platform_params.py)
- post-bootstrap head-end verification through [verify_headend_bootstrap.py](/scripts/platform/verify_headend_bootstrap.py)
