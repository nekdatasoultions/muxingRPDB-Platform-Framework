...
def main() -> int:
    ...
    report = (
        validate_installed_cgnat(package_dir, Path(args.cgnat_root).resolve(), pki_review_dir=pki_review_dir)
        if args.cgnat_root
        else validate_cgnat_package(package_dir, pki_review_dir=pki_review_dir)
    )
